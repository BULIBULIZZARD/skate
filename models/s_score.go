...
type SScore struct {
	Id         int    `json:"id" xorm:"not null pk autoincr index INT(5)"`
	...
	PlayerId   int    `json:"player_id" xorm:"not null default 0 index INT(4)"`
	...
	MatchTime  string `json:"match_time" xorm:"not null default '' VARCHAR(45)"`
}
